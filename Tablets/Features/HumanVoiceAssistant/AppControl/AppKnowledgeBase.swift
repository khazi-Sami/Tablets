...
final class AppKnowledgeBase {
    private let features: [AppFeatureInfo] = [
        ...
        .init(featureName: "Pregnancy & Planning", description: "Track your pregnancy week by week, log symptoms, count baby kicks, track weight, and manage appointments.", exampleVoiceCommands: ["Open pregnancy", "Log pregnancy symptoms", "Count baby kicks", "Log pregnancy weight", "What week am I on", "When is my due date"], navigationIntent: .openPregnancyPlanning, keywords: ["pregnancy", "pregnant", "maternity", "baby kicks", "due date", "baby tracker"]),
